...
INSERT INTO links_new (id, alias, original_url, created_at, owner_id, name, lifetime_sec)
SELECT id, alias, original_url, created_at, owner_id, name, lifetime_sec FROM links;
